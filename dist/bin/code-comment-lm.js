...
program
    ...
    .description('A CLI tool leveraging LLMs to manipulate code comments - currently supporting only Java comment translation - with a backup of the original files.')
    .version('1.0.0');
program
